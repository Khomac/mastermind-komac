    ...
    if (zpliku.is_open())
    {
        ...
        for (zczytywanie2=0;zczytywanie2<10;zczytywanie2++)
        {
            ...
            for (std::string linia;std::getline (zpliku,linia);)
            {
                ...
                {
                    //tabela_ksywek[zczytywanie1][zczytywanie2]<<strdup(linia.c_str());
                    //wskaznik_na_ksywki[zczytywanie1][zczytywanie2]=new char[ linia.length() + 1 ];
                    strcpy (tabela_ksywek[zczytywanie1][zczytywanie2],linia.c_str());
                    //tabela_ksywek[zczytywanie1][zczytywanie2]=* wskaznik_na_ksywki[zczytywanie1][zczytywanie2];
                    //tabela_ksywek[zczytywanie1][zczytywanie2]=linia;
                    //memcpy(tabela_ksywek[zczytywanie1][zczytywanie2], linia.c_str(), linia.size() + 1);
                    //system("PAUSE");
